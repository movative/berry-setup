...
To easily start the project I use docker-containers, docker-compose and environment files to configure them.<br> [[Logo created with diagram.net]](https://app.diagrams.net/)
<br>
